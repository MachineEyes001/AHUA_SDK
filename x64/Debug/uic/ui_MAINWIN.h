...
public:
    ...
    void setupUi(QMainWindow *MAINWINClass)
    {
        ...
        MAINWINClass->resize(1080, 720);
        MAINWINClass->setMinimumSize(QSize(1080, 671));
        centralWidget = new QWidget(MAINWINClass);
        centralWidget->setObjectName("centralWidget");
        centralWidget->setMinimumSize(QSize(1055, 671));
        ...
        sideBar->setMinimumSize(QSize(55, 671));
...
"}"));
    ...
    {
        MAINWINClass->setWindowTitle(QCoreApplication::translate("MAINWINClass", "KeyboardGrab", nullptr));
