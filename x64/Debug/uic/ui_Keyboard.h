...
""));
        ...
        gridLayoutWidget_2->setGeometry(QRect(10, 150, 461, 97));
...
""));
        ...
        frame_3->setMinimumSize(QSize(270, 220));
...
""));
        ...
        layoutWidget->setGeometry(QRect(10, 20, 461, 41));
        horizontalLayout_2 = new QHBoxLayout(layoutWidget);
        horizontalLayout_2->setSpacing(6);
        horizontalLayout_2->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_2->setObjectName("horizontalLayout_2");
        horizontalLayout_2->setContentsMargins(0, 0, 0, 0);
        pushButtonOpenCam = new QPushButton(layoutWidget);
...
"}"));
        ...
        pushButtonStartCam = new QPushButton(layoutWidget);
...
"}"));
        ...
        pushButtonStopCam = new QPushButton(layoutWidget);
...
"}"));
        ...
        pushButtonCloseCam = new QPushButton(layoutWidget);
...
"}"));
        ...
        pushButtonSoftTrig = new QPushButton(layoutWidget);
...
"}"));
        ...
        gridLayoutWidget_7->setGeometry(QRect(10, 150, 461, 97));
...
""));
        ...
        gridLayout_7->addItem(verticalSpacer_5, 1, 1, 1, 1);

        frame_5 = new QFrame(centralWidget);
        frame_5->setObjectName("frame_5");
        frame_5->setMinimumSize(QSize(0, 70));
        frame_5->setFrameShape(QFrame::Panel);
        frame_5->setFrameShadow(QFrame::Raised);
        frame_5->setLineWidth(2);
        frame_8 = new QFrame(frame_5);
        frame_8->setObjectName("frame_8");
        frame_8->setGeometry(QRect(0, 0, 1021, 21));
        ...
        label_27->setGeometry(QRect(470, 0, 41, 21));
        gridLayoutWidget_3 = new QWidget(frame_5);
        gridLayoutWidget_3->setObjectName("gridLayoutWidget_3");
        gridLayoutWidget_3->setGeometry(QRect(10, 20, 961, 42));
        gridLayout_4 = new QGridLayout(gridLayoutWidget_3);
        gridLayout_4->setSpacing(6);
        gridLayout_4->setContentsMargins(11, 11, 11, 11);
        gridLayout_4->setObjectName("gridLayout_4");
        gridLayout_4->setContentsMargins(0, 0, 0, 0);
        comm_Botton = new QPushButton(gridLayoutWidget_3);
...
"    }"));
        ...
        gridLayout_7->addWidget(frame_5, 2, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *KeyboardClass)
    {
        ...
        label_27->setText(QCoreApplication::translate("KeyboardClass", " \351\200\232\350\256\257", nullptr));
