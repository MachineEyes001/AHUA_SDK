...
"}"));
        ...
        gridLayout->addWidget(Log_lineEdit, 5, 1, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(SaveTime_lineEdit, 7, 1, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(LogPath_pushButton, 5, 2, 1, 1);
